          ...
          <div className="flex justify-center lg:justify-end space-x-6 animate-fadeInUp">
            <div className="relative group">
              <div className="w-64 h-64 lg:w-72 lg:h-72 rounded-full bg-gradient-to-br from-[#08295f] to-[#37bdf8] p-2 transform group-hover:scale-110 transition-transform duration-500">
                <img
                  src="https://i.postimg.cc/2SvNk6LL/d3bf859c.jpg"
            ...
            <div className="relative">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 space-y-6 transform hover:scale-105 transition-transform duration-300 hover:shadow-xl">
                <p className="text-lg text-gray-700 leading-relaxed transform hover:scale-105 transition-transform duration-300">
                  "Depuis la création d'ON AFRICA TP en 2009, notre vision a toujours été claire : 
                  contribuer au développement durable de l'Afrique en offrant des solutions 
                  innovantes et adaptées aux réalités locales."
                </p>
                
                <p className="text-lg text-gray-700 leading-relaxed transform hover:scale-105 transition-transform duration-300">
                  "Notre engagement envers l'excellence, l'innovation et le respect de 
                  l'environnement guide chacune de nos actions. Nous croyons fermement que 
                  l'Afrique mérite des infrastructures de qualité mondiale."
                </p>
                
                <p className="text-lg text-gray-700 leading-relaxed transform hover:scale-105 transition-transform duration-300">
                  "Chaque projet que nous réalisons est une opportunité de démontrer notre 
                  expertise et notre détermination à construire un avenir meilleur pour nos 
                  communautés et notre continent."
                </p>
